            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <View style={styles.digitalContainer}>
                    <Text style={styles.textContent}>
                        ICT (Information and Communication Technology)* significantly enhances research and data analysis by providing tools for data collection, storage, analysis, and collaboration. It allows for efficient and secure data management through cloud platforms and enables complex statistical and qualitative analyses using software like SPSS, R, and NVivo. ICT facilitates global collaboration with tools like Google Docs and Microsoft Teams and offers access to vast online research resources.{"\n"}{"\n"}
                        Additionally, advanced technologies like AI and machine learning assist in analyzing large datasets, while data visualization tools like Tableau and Power BI help present findings effectively. Despite challenges like data security and the need for technical skills, ICT is transforming research by making processes faster, more accessible, and collaborative.{"\n"}
                    </Text>
                </View>
              </ScrollView> 
